const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BboR2yWF.js","assets/index-B9VlIcv8.js","assets/supabase-Dulr8jbl.js"])))=>i.map(i=>d[i]);
import{_ as r,t as o,f as s}from"./index-B9VlIcv8.js";const c="https://scandgo.com/";function d(t){var a;const e=((a=t.tenants)==null?void 0:a.invite_token)||"";return e?`${c}login.html?join=${e}`:""}async function l(t){try{await navigator.clipboard.writeText(t)}catch{const e=Object.assign(document.createElement("textarea"),{value:t});e.style.cssText="position:fixed;opacity:0;pointer-events:none",document.body.appendChild(e),e.select(),document.execCommand("copy"),e.remove()}}function p(){var e;const t=window.Capacitor;return!!((e=t==null?void 0:t.isNativePlatform)!=null&&e.call(t)||t!=null&&t.getPlatform&&t.getPlatform()!=="web")}async function f({title:t,text:e,url:a}){if(p())try{const{Share:n}=await r(async()=>{const{Share:i}=await import("./index-BboR2yWF.js");return{Share:i}},__vite__mapDeps([0,1,2]));await n.share({title:t,text:e,url:a,dialogTitle:"초대 링크 공유"});return}catch(n){if(/cancel/i.test((n==null?void 0:n.message)||""))return}if(navigator.share){const n=a?{title:t,text:e,url:a}:{title:t,text:e};try{await navigator.share(n);return}catch(i){if((i==null?void 0:i.name)==="AbortError")return}}await l(a||e),o("링크가 복사됐습니다. 카카오톡·문자에 붙여넣기 해주세요","success",4e3)}function v(t){const e=d(t);return e?`
